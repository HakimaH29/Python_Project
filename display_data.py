...
#configuration to be able to add to the database
...
#this will display the data.html template when you choose to go to another page /my_data
@app.route('/my_data/') 
def data_world(): 
...
#once you choose the filter and select that in the url, you will get the filtered data. 
